		...
		categories.forEach((c) => {
			...
			categoryButton?.addEventListener("click", () => {
                ...
                if (activeCategoryId !== null) {
					...
					const prevCategoryButton = getElementById(`category-${activeCategoryId}`);
					prevCategoryButton?.classList.remove("bg-peddy-primary/95", "text-white");
					prevCategoryButton?.classList.add("bg-peddy-primary/5", "text-peddy-primary");
				}

				// Set the clicked button as active
				activeCategoryId = id;
				categoryButton.classList.add("bg-peddy-primary/95", "text-white");
				categoryButton.classList.remove("bg-peddy-primary/5", "text-peddy-primary");
